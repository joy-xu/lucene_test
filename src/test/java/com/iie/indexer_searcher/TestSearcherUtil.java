...
import com.iie.indexer_searcher.SearcherUtil;
...
public class TestSearcherUtil {
	...
	public void testCopyFiles() {
		...
		for (File f : file.listFiles()) {
			String destFileName = FilenameUtils.getFullPath(f.getAbsolutePath()) 
					+ FilenameUtils.getBaseName(f.getName()) + ".hcc";
			try {
	...
	public void testSearchPage() throws Exception {
		su.searchPage("content:\"you\"", 2, 5);
	}
	
	@Test
	public void testSearchPageByAfter() throws Exception {
		su.searchPageByAfter("you", 2, 5);
	}
}
